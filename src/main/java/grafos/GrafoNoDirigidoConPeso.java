...
@Alternative
public class GrafoNoDirigidoConPeso extends Grafo implements IGrafoConPeso{
	...
	public void addArco(Nodo nodoOrigen, Nodo nodoDestino, int peso) {
		IArcoConPeso arco = (IArcoConPeso) FabricaArco.getArcoConPeso();
		...
		arco = (IArcoConPeso) FabricaArco.getArco();
		arco.setOrigen(nodoOrigen);
		arco.setDestino(nodoDestino);
		arco.setPeso(peso);
		arcos.add(arco);
